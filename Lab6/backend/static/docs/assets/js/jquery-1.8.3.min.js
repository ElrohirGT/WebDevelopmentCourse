...
;(function(e, t) {
  ...
  function tn(e, t, n) {
    ...
    let i = !0
    const s = v.support.boxSizing && v.css(e, 'boxSizing') === 'border-box'
    if (r <= 0 || r == null) {
      r = Dt(e, t)
  ...
  function Ln(e, n) {
    let r
    let i
    const s = v.ajaxSettings.flatOptions || {}
  ...
  function Kn(e, t, n) {
    ...
    const s = 0
    const o = Xn.length
    const u = v.Deferred().always(() => {
      delete a.elem
    })
    var a = function() {
      const t = qn || $n()
      const n = Math.max(0, f.startTime + f.duration - t)
      const r = n / f.duration || 0
      const i = 1 - r
      let s = 0
      const o = f.tweens.length
    ...
    var f = u.promise({
      ...
      tweens: [],
      createTween(t, n, r) {
        const i = v.Tween(e, f.opts, t, n, f.opts.specialEasing[t] || f.opts.easing)
        return f.tweens.push(i), i
      },
      stop(t) {
        let n = 0
        const r = t ? f.tweens.length : 0
    ...
    return Jn(f, l),
      ...
      f.progress(f.opts.progress).done(f.opts.done, f.opts.complete).fail(f.opts.fail).always(
        f.opts.always,
      )
  }
  function Qn(e, t) {
  ...
  function Gn(e, t, n) {
    ...
    || (l = v._queueHooks(e, 'fx'),
      ...
      n.overflow && (p.overflow = 'hidden',
        v.support.shrinkWrapBlocks || h.done(() => {
  ...
  const c = Array.prototype.indexOf
  const h = Object.prototype.toString
  const p = Object.prototype.hasOwnProperty
  const d = String.prototype.trim
  var v = function(e, t) {
    return new v.fn.init(e, t, n)
  }
  const m = /[\-+]?(?:\d*\.|)\d+(?:[eE][\-+]?\d+|)/.source
  const g = /\S/
  var y = /\s+/
  const b = /^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g
  const w = /^(?:[^#<]*(<[\w\W]+>)[^>]*$|#([\w\-]*)$)/
  const E = /^<(\w+)\s*\/?>(?:<\/\1>|)$/
  const S = /^[\],:{}\s]*$/
  const x = /(?:^|:|,)(?:\s*\[)+/g
  const T = /\\(?:["\\\/bfnrt]|u[\da-fA-F]{4})/g
  ...
  v.fn = v.prototype = {
    ...
    v.extend({
      ...
      isPlainObject(e) {
        ...
        try {
          if (
            e.constructor && !p.call(e, 'constructor')
      ...
      makeArray(e, t) {
        ...
        return e != null
          && (n = v.type(e),
            e.length == null || n === 'string' || n === 'function' || n === 'regexp'
              || v.isWindow(e)
              ? f.call(r, e)
              : v.merge(r, e)),
          r
  ...
  v.Callbacks = function(e) {
    ...
    v.extend({
      Deferred(e) {
        const t = [['resolve', 'done', v.Callbacks('once memory'), 'resolved'], [
          'reject',
          'fail',
      ...
      when(e) {
        let t = 0
        const n = l.call(arguments)
        const r = n.length
        let i = r !== 1 || e && v.isFunction(e.promise) ? r : 0
        const s = i === 1 ? e : v.Deferred()
    ...
    v.support = function() {
      ...
      return v(() => {
        ...
        let s
        let o
        const u = 'padding:0;margin:0;border:0;display:block;overflow:hidden;'
        const a = i.getElementsByTagName('body')[0]
        if (!a) return
  ...
  v.extend({
    ...
    removeData(e, t, n) {
      ...
      const o = e.nodeType
      const u = o ? v.cache : e
      const a = o ? e[v.expando] : v.expando
      if (!u[a]) return
      if (t) {
        r = n ? u[a] : u[a].data
        if (r) {
  ...
  const q = /[\t\r\n]/g
  const R = /\r/g
  const U = /^(?:button|input)$/i
  const z = /^(?:button|input|object|select|textarea)$/i
  const W = /^a(?:rea|)$/i
  const X =
    /^(?:autofocus|autoplay|async|checked|controls|defer|disabled|hidden|loop|multiple|open|readonly|required|scoped|selected)$/i
  const V = v.support.getSetAttribute
  v.fn.extend({
    attr(e, t) {
        ...
        this.each(function(r) {
          ...
          i ? s = e.call(this, r, o.val()) : s = e,
            s == null
              ...
              : typeof s === 'number'
              ? s += ''
              : v.isArray(s) && (s = v.map(s, (e) => (e == null ? '' : `${e}`))),
      ...
      valHooks: {
        ...
        select: {
          get(e) {
            ...
            const s = e.type === 'select-one' || i < 0
            const o = s ? null : []
            const u = s ? i + 1 : r.length
            let a = i < 0 ? u : s ? i : 0
            for (; a < u; a++) {
              n = r[a]
              if (
    ...
    v.support.hrefNormalized || v.each(['href', 'src', 'width', 'height'], (e, n) => {
  ...
  const $ = /^(?:textarea|input|select)$/i
  const J = /^([^\.]*|)(?:\.(.+)|)$/
  const K = /(?:^|\s)hover(\.\S+|)\b/
  const Q = /^key/
  const G = /^(?:mouse|contextmenu)|click/
  const Y = /^(?:focusinfocus|focusoutblur)$/
  const Z = function(e) {
  ...
  v.event = {
    ...
    remove(e, t, n, r, i) {
      ...
      for (s = 0; s < t.length; s++) {
        ...
        for (c = 0; c < d.length; c++) {
          m = d[c],
            (i || a === m.origType) && (!n || n.guid === m.guid) && (!f || f.test(m.namespace))
    ...
    trigger(n, r, s, o) {
      if (!s || s.nodeType !== 3 && s.nodeType !== 8) {
        ...
        return n.type = y,
          ...
          && (y !== 'click' || !v.nodeName(s, 'a')) && v.acceptData(s) && h && s[y]
          && (y !== 'focus' && y !== 'blur' || n.target.offsetWidth !== 0) && !v.isWindow(s)
          && (c = s[h],
            c && (s[h] = null),
            v.event.triggered = y,
            s[y](),
    ...
    dispatch(n) {
      ...
      let h
      let p
      const d = (v._data(this, 'events') || {})[n.type] || []
      const m = d.delegateCount
      const g = l.call(arguments)
      const y = !n.exclusive && !n.namespace
      const b = v.event.special[n.type] || {}
      const w = []
      ...
      for (r = 0; r < w.length && !n.isPropagationStopped(); r++) {
        ...
        for (i = 0; i < a.matches.length && !n.isImmediatePropagationStopped(); i++) {
          c = a.matches[i]
          if (
            y || !n.namespace && !c.namespace || n.namespace_re && n.namespace_re.test(c.namespace)
          ) {
            n.data = c.data,
              n.handleObj = c,
    ...
    mouseHooks: {
      ...
      filter(e, n) {
        ...
        let o
        const u = n.button
        const a = n.fromElement
        return e.pageX == null && n.clientX != null
          && (r = e.target.ownerDocument || i,
            s = r.documentElement,
            o = r.body,
            e.pageX = n.clientX + (s && s.scrollLeft || o && o.scrollLeft || 0)
              - (s && s.clientLeft || o && o.clientLeft || 0),
            e.pageY = n.clientY + (s && s.scrollTop || o && o.scrollTop || 0)
    ...
    fix(e) {
      ...
      let n
      const r = e
      const s = v.event.fixHooks[e.type] || {}
      const o = s.props ? this.props.concat(s.props) : this.props
      e = v.Event(r)
    ...
    simulate(e, t, n, r) {
      const i = v.extend(new v.Event(), n, { type: e, isSimulated: !0, originalEvent: {} })
    ...
    v.support.submitBubbles || (v.event.special.submit = {
      setup() {
        ...
        v.event.add(this, 'click._submit keypress._submit', (e) => {
          const n = e.target
          const r = v.nodeName(n, 'input') || v.nodeName(n, 'button') ? n.form : t
          r && !v._data(r, '_submit_attached') && (v.event.add(r, 'submit._submit', (e) => {
            e._submit_bubble = !0
          }),
    ...
    v.support.changeBubbles || (v.event.special.change = {
      setup() {
        ...
        v.event.add(this, 'beforeactivate._change', (e) => {
          const t = e.target
          $.test(t.nodeName) && !v._data(t, '_change_attached')
      ...
      handle(e) {
        const t = e.target
        if (
          this !== t || e.isSimulated || e.isTrigger || t.type !== 'radio' && t.type !== 'checkbox'
        ) {
    ...
    v.support.focusinBubbles || v.each({ focus: 'focusin', blur: 'focusout' }, (e, t) => {
      let n = 0
      const r = function(e) {
    ...
    (function(e, t) {
          ...
          if (i = R.exec(e)) {
            if (f = i[1]) {
              if (l === 9) {
                ...
                t.ownerDocument && (s = t.ownerDocument.getElementById(f)) && u(t, s) && s.id === f
              ) return n.push(s), n
            } else {
      ...
      function ct(e, t, n, r, i, s) {
        return r && !r[d] && (r = ct(r)),
          ...
          N((s, o, u, a) => {
            ...
            const p = []
            const d = o.length
            const v = s || dt(t || '*', u.nodeType ? [u] : u, [])
            const m = e && (s || !t) ? lt(v, h, e, u, a) : v
            let g = n ? i || (s ? e : d || r) ? [] : o : m
            n && n(m, g, u, a)
            if (r) {
      ...
      function ht(e) {
        ...
        let r
        const s = e.length
        const o = i.relative[e[0].type]
        const u = o || i.relative[' ']
        let a = o ? 1 : 0
        const f = at((e) => e === t, u, !0)
        const l = at((e) => T.call(t, e) > -1, u, !0)
        let h = [function(e, n, r) {
      ...
      function pt(e, t) {
        ...
        const o = function(u, a, f, l, h) {
          ...
          const T = h != null
          const N = c
          const C = u || s && i.find.TAG('*', h && a.parentNode || a)
          const k = b += N == null ? 1 : Math.E
          T && (c = a !== g && a, n = o.el)
          for (; (p = C[w]) != null; w++) {
            if (s && p) {
              for (d = 0; v = e[d]; d++) {
      ...
      function vt(e, t, n, r, s) {
        ...
        if (!r && h.length === 1) {
          u = h[0] = h[0].slice(0)
          if (
            u.length > 2 && (f = u[0]).type === 'ID' && t.nodeType === 9 && !s
            && i.relative[u[1].type]
          ) {
      ...
      const C = function() {
        const e = {}
        const t = []
        return N((n, r) => (t.push(n) > i.cacheLength && delete e[t.shift()], e[`${n} `] = r), e)
      }
      const k = C()
      var L = C()
      const A = C()
      const O = '[\\x20\\t\\r\\n\\f]'
      const M = '(?:\\\\.|[-\\w]|[^\\x00-\\xa0])+'
      const _ = M.replace('w', 'w#')
      const D = '([*^$|!~]?=)'
      const P =
        `\\[${O}*(${M})${O}*(?:${D}${O}*(?:(['"])((?:\\\\.|[^\\\\])*?)\\3|(${_})|)|)${O}*\\]`
      const H =
        `:(${M})(?:\\((?:(['"])((?:\\\\.|[^\\\\])*?)\\2|([^()[\\]]*|(?:(?:${P})|[^:]|\\\\.)*|.*))\\)|)`
      const B = `:(even|odd|eq|gt|lt|nth|first|last)(?:\\(${O}*((?:-\\d)?\\d*)${O}*\\)|)(?=[^-]|$)`
      ...
      var J = {
        ...
        POS: new RegExp(B, 'i'),
        CHILD: new RegExp(
          `^:(only|nth|first|last)-child(?:\\(${O}*(even|odd|(([+-]|)(\\d*)n|)${O}*(?:([+-]|)${O}*(\\d+)|))${O}*\\)|)`,
          'i',
        ),
      ...
      const Q = K((e) => (e.appendChild(g.createComment('')), !e.getElementsByTagName('*').length))
      const G = K((
        e,
      ) => (e.innerHTML = "<a href='#'></a>",
        e.firstChild && typeof e.firstChild.getAttribute !== p
      ...
      nt.matches = function(e, t) {
          ...
          return r || (t = t.toLowerCase()),
            (n = i.attrHandle[t])
              ...
              : (n = e.getAttributeNode(t),
                n
                  ? typeof e[t] === 'boolean' ? e[t] ? t : null : n.specified ? n.value : null
                  : null)
        },
        i = nt.selectors = {
          cacheLength: 50,
          ...
          preFilter: {
            ...
            PSEUDO(e) {
              ...
              if (e[3]) e[2] = e[3]
                ...
                q.test(t) && (n = ut(t, !0)) && (n = t.indexOf(')', t.length - n) - t.length)
          ...
          filter: {
            ID: r
              ...
              : function(e) {
                return e = e.replace($, ''), function(t) {
                  const n = typeof t.getAttributeNode !== p && t.getAttributeNode('id')
                  return n && n.value === e
                }
              },
            TAG(e) {
            ...
            CLASS(e) {
              ...
              return t
                || (t = new RegExp(`(^|${O})${e}(${O}|$)`))
                  && k(e, (e) =>
                    t.test(
                      e.className || typeof e.getAttribute !== p && e.getAttribute('class') || '',
                    ))
            },
            ATTR(e, t, n) {
              return function(r, i) {
            ...
            PSEUDO(e, t) {
              let n
              const r = i.pseudos[e] || i.setFilters[e.toLowerCase()]
        ...
        g.querySelectorAll && (function() {
          ...
          let i = [':focus']
          let s = [':active']
          const u = y.matchesSelector || y.mozMatchesSelector || y.webkitMatchesSelector
  ...
  const nt = /Until$/
  const rt = /^(?:parents|prev(?:Until|All))/
  var it = /^.[^:#\[\.,]*$/
  const st = v.expr.match.needsContext
  const ot = {
    children: !0,
    contents: !0,
    next: !0,
  ...
  v.fn.extend({
    ...
    is(e) {
      return !!e
        && (typeof e === 'string'
          ? st.test(e) ? v(e, this.context).index(this[0]) >= 0 : v.filter(e, this).length > 0
    ...
    closest(e, t) {
      ...
      const i = this.length
      let s = []
      const o = st.test(e) || typeof e !== 'string' ? v(e, t || this.context) : 0
      for (; r < i; r++) {
        n = this[r]
    ...
    index(e) {
      return e
        ? typeof e === 'string' ? v.inArray(this[0], v(e)) : v.inArray(e.jquery ? e[0] : e, this)
        : this[0] && this[0].parentNode
        ? this.prevAll().length
        : -1
    },
    add(e, t) {
      const n = typeof e === 'string' ? v(e, t) : v.makeArray(e && e.nodeType ? [e] : e)
      const r = v.merge(this.get(), n)
    ...
    v.extend({
      ...
      dir(e, n, r) {
        ...
        let s = e[n]
        while (
          s && s.nodeType !== 9 && (r === t || s.nodeType !== 1 || !v(s).is(r))
  ...
  const ht = / jQuery\d+="(?:null|\d+)"/g
  const pt = /^\s+/
  const dt = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi
  const vt = /<([\w:]+)/
  const mt = /<tbody/i
  const gt = /<|&#?\w+;/
  const yt = /<(?:script|style|link)/i
  const bt = /<(?:script|object|embed|option|style)/i
  const wt = new RegExp(`<(?:${ct})[\\s/>]`, 'i')
  var Et = /^(?:checkbox|radio)$/
  const St = /checked\s*(?:[^=]|=\s*.checked.)/i
  const xt = /\/(java|ecma)script/i
  const Tt = /^\s*<!(?:\[CDATA\[|\-\-)|[\]\-]{2}>\s*$/g
  const Nt = {
  ...
  const Ct = lt(i)
  const kt = Ct.appendChild(i.createElement('div'))
  Nt.optgroup = Nt.option,
    ...
    v.fn.extend({
      ...
      wrapAll(e) {
        ...
        if (this[0]) {
          const t = v(e, this[0].ownerDocument).eq(0).clone(!0)
      ...
      html(e) {
        return v.access(
          ...
          function(e) {
            ...
            if (
              typeof e === 'string' && !yt.test(e) && (v.support.htmlSerialize || !wt.test(e))
      ...
      replaceWith(e) {
        return ut(this[0])
          ? this.length ? this.pushStack(v(v.isFunction(e) ? e() : e), 'replaceWith', e) : this
          : v.isFunction(e)
          ? this.each(function(t) {
            const n = v(this)
            const r = n.html()
    ...
    v.buildFragment = function(e, n, r) {
      ...
      return n = n || i,
        n = !n.nodeType && n[0] || n,
        n = n.ownerDocument || n,
        e.length === 1 && typeof a === 'string' && a.length < 512 && n === i && a.charAt(0) === '<'
        && !bt.test(a) && (v.support.checkClone || !St.test(a))
        && (v.support.html5Clone || !wt.test(a)) && (o = !0, s = v.fragments[a], u = s !== t),
    ...
    v.each({
      ...
      v.fn[e] = function(n) {
        ...
        const o = v(n)
        const u = o.length
        const a = this.length === 1 && this[0].parentNode
    ...
    v.extend({
      ...
      cleanData(e, t) {
        ...
        const u = v.expando
        const a = v.cache
        const f = v.support.deleteExpando
        const l = v.event.special
        for (; (i = e[o]) != null; o++) {
          if (t || v.acceptData(i)) {
            r = i[u], n = r && a[r]
            if (n) {
    ...
    (function() {
      ...
      v.uaMatch = function(e) {
        e = e.toLowerCase()
        const t = /(chrome)[ \/]([\w.]+)/.exec(e) || /(webkit)[ \/]([\w.]+)/.exec(e)
  ...
  const It = /^(none|table(?!-c[ea]).+)/
  const qt = /^margin/
  var Rt = new RegExp(`^(${m})(.*)$`, 'i')
  var Ut = new RegExp(`^(${m})(?!px)[a-z%]+$`, 'i')
  const zt = new RegExp(`^([-+])=(${m})`, 'i')
  var Wt = { BODY: 'block' }
  const Xt = { position: 'absolute', visibility: 'hidden', display: 'block' }
  const Vt = { letterSpacing: 0, fontWeight: 400 }
  var $t = ['Top', 'Right', 'Bottom', 'Left']
  var Jt = ['Webkit', 'O', 'Moz', 'ms']
  const Kt = v.fn.toggle
  v.fn.extend({
    css(e, n) {
      return v.access(
        this,
    ...
    e.getComputedStyle
      ? Dt = function(t, n) {
        ...
        let s
        let o
        const u = e.getComputedStyle(t, null)
        const a = t.style
        return u
    ...
    v.support.opacity || (v.cssHooks.opacity = {
      ...
      set(e, t) {
        ...
        const i = v.isNumeric(t) ? `alpha(opacity=${t * 100})` : ''
        const s = r && r.filter || n.filter || ''
        n.zoom = 1
    ...
    v(() => {
      v.support.reliableMarginRight || (v.cssHooks.marginRight = {
        ...
        !v.support.pixelPosition && v.fn.position && v.each(['top', 'left'], (e, t) => {
          v.cssHooks[t] = {
            get(e, n) {
              if (n) {
                const r = Dt(e, t)
    ...
    serializeArray() {
      return this.map(function() {
        ...
        return n == null
          ? null
          : v.isArray(n)
          ? v.map(n, (e, n) => ({ name: t.name, value: e.replace(on, '\r\n') }))
  ...
  const hn = /#.*$/
  const pn = /^(.*?):[ \t]*([^\r\n]*)\r?$/mg
  const dn = /^(?:about|app|app\-storage|.+\-extension|file|res|widget):$/
  const vn = /^(?:GET|HEAD)$/
  const mn = /^\/\//
  const gn = /\?/
  const yn = /<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi
  const bn = /([?&])_=[^&]*/
  const wn = /^([\w\+\.\-]+:)(?:\/\/([^\/?#:]*)(?::(\d+)|)|)/
  const En = v.fn.load
  var Sn = {}
        ...
        if (!c.beforeSend || c.beforeSend.call(h, x, c) !== !1 && E !== 2) {
          ...
          if (!o) T(-1, 'No Transport')
            ...
            x.readyState = 1,
              ...
              c.async && c.timeout > 0 && (u = setTimeout(() => {
                x.abort('timeout')
              }, c.timeout))
            try {
              E = 1, o.send(b, T)
  ...
  v.ajaxSetup({
    ...
    v.ajaxPrefilter('json jsonp', (n, r, i) => {
      ...
      const l = n.jsonp !== !1
      const c = l && Dn.test(f)
      const h = l && !c && typeof a === 'string'
        && !(n.contentType || '').indexOf('application/x-www-form-urlencoded') && Dn.test(a)
    ...
    v.ajaxTransport('script', (e) => {
      if (e.crossDomain) {
        let n
        const r = i.head || i.getElementsByTagName('head')[0] || i.documentElement
        return {
          send(s, o) {
  ...
  v.ajaxSettings.xhr = e.ActiveXObject
    ...
    v.support.ajax && v.ajaxTransport((n) => {
  ...
  v.Animation = v.extend(Kn, {
    ...
    Yn.prototype = {
      ...
      run(e) {
        let t
        const n = Yn.propHooks[this.prop]
    ...
    v.fn.extend({
      fadeTo(e, t, n, r) {
        return this.filter(Gt).css('opacity', 0).show().end()
          .animate({ opacity: t }, e, n, r)
      },
      animate(e, t, n, r) {
        const i = v.isEmptyObject(e)
        const s = v.speed(t, n, r)
        const o = function() {
  ...
  v.fn.offset = function(e) {
    ...
    v.offset = {
      ...
      setOffset(e, t, n) {
        ...
        const s = i.offset()
        const o = v.css(e, 'top')
        const u = v.css(e, 'left')
        const a = (r === 'absolute' || r === 'fixed') && v.inArray('auto', [o, u]) > -1
        const f = {}
        let l = {}
        let c
        let h
    ...
    v.fn.extend({
      position() {
        ...
        const n = this.offset()
        const r = er.test(t[0].nodeName) ? { top: 0, left: 0 } : t.offset()
    ...
    v.each({ Height: 'height', Width: 'width' }, (e, n) => {
      v.each({ padding: `inner${e}`, content: n, '': `outer${e}` }, (r, i) => {
        v.fn[i] = function(i, s) {
          const o = arguments.length && (r || typeof i !== 'boolean')
          const u = r || (i === !0 || s === !0 ? 'margin' : 'border')
          return v.access(
            this,
            (n, r, i) => {
              let s
    ...
    e.jQuery = e.$ = v,
    typeof define === 'function' && define.amd && define.amd.jQuery && define('jquery', [], () => v)
})(window)
